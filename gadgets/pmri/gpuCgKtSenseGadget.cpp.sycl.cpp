...
namespace Gadgetron{
  ...
  int gpuCgKtSenseGadget::process_config(ACE_Message_Block *mb) try {
    ...
    /*
    DPCT1093:38: The "device_number_" device may be not the one intended for
  ...
  int gpuCgKtSenseGadget::process(
    ...
    *device_samples *= *dcw;
	...
	new GadgetContainerMessage< hoNDArray< std::complex<float> > >();      
      ...
      */
      dpct::err0 err = 0;
      /*
      DPCT1000:40: Error handling if-stmt was detected but could not be
      rewritten.
      */
      if (err != 0) {
        /*
        DPCT1009:42: SYCL reports errors using exceptions and does not use error
