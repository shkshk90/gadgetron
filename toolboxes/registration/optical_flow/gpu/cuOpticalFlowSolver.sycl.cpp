...
namespace Gadgetron{
  ...
  void cuOpticalFlowSolver<T, D>::setup_grid(dpct::dim3* blockDim, dpct::dim3* gridDim, unsigned int number_of_elements,
                                             unsigned int num_batches, bool use_2d_blocks,
                                             unsigned int num_unknowns) try {
    int device;
  ...
  /*
DPCT1110:0: The total declared local variable size in device function spatial_grad_kernel exceeds 128 bytes and may
