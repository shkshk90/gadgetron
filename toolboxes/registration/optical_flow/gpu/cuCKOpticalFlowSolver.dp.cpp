...
/* DPCT_ORIG         CorneliusKanade_kernel<T, D><<<gridDim, blockDim, (blockDim.x * blockDim.y) * sizeof(T)>>>(
        ...
        /*
        DPCT1049:102: The work-group size passed to the SYCL kernel may exceed the limit. To get the device limit, query
        info::device::max_work_group_size. Adjust the work-group size if needed.
        */
        /*
        DPCT1129:101: The type "vector_td<unsigned int, D>" is used in the SYCL kernel, but it is not device copyable.
...
template <class REAL, unsigned int D>
/*
DPCT1110:100: The total declared local variable size in device function CorneliusKanade_kernel exceeds 128 bytes and may
