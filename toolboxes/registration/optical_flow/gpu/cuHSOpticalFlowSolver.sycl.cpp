...
namespace Gadgetron{
      ...
      */
      {
         ...
         dpct::get_in_order_queue().submit([&](sycl::handler& cgh) {
            ...
            auto stencil_image_stencil_image_get_data_ptr_ct1 = (stencil_image) ? stencil_image->get_data_ptr() : 0x0;
  ...
  /*
DPCT1110:0: The total declared local variable size in device function HornSchunk_kernel exceeds 128 bytes and may cause
