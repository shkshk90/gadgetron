...
namespace Gadgetron{
  ...
  /*
DPCT1110:0: The total declared local variable size in device function write_sort_arrays_kernel exceeds 128 bytes and may
...
*/
  ...
  cuLinearResampleOperator<T,D>::write_sort_arrays( void *pSort_keys )
  {
    assert(pSort_keys);
    dpct::device_vector<unsigned int>& sort_keys = *reinterpret_cast<dpct::device_vector<unsigned int>*>(pSort_keys);
