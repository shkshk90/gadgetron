...
namespace Gadgetron
{
    ...
    __inline__ __device__ __host__ ConvolutionKernel<REAL, D, K>::ConvolutionKernel(REAL width)
      : width_(width)
    ...
    template<class REAL, unsigned int D, template<class, unsigned int> class K>
    __inline__ __device__ __host__ REAL ConvolutionKernel<REAL, D, K>::get(const vector_td<REAL, D>& u) const
    {
    ...
    template<class REAL, unsigned int D, template<class, unsigned int> class K>
    __inline__ __device__ __host__ REAL ConvolutionKernel<REAL, D, K>::get(REAL r, size_t ax) const
    {
        r = abs(r);
        if (r > this->radius_)
            return REAL(0);
    ...
    template<class REAL, unsigned int D, template<class, unsigned int> class K>
    __inline__ __device__ __host__ REAL ConvolutionKernel<REAL, D, K>::compute(const vector_td<REAL, D>& u) const
    {
    ...
    template<class REAL, unsigned int D, template<class, unsigned int> class K>
    __inline__ __device__ __host__ REAL ConvolutionKernel<REAL, D, K>::compute(REAL r, size_t ax) const
    {
    ...
    template<class REAL, unsigned int D, template<class, unsigned int> class K>
    __inline__ __device__ __host__ REAL ConvolutionKernel<REAL, D, K>::lookup(const vector_td<REAL, D>& u) const
    {
    ...
    template<class REAL, unsigned int D, template<class, unsigned int> class K>
    __inline__ __device__ __host__ REAL ConvolutionKernel<REAL, D, K>::lookup(REAL r, size_t ax) const
    {
    ...
    template<class REAL, unsigned int D, template<class, unsigned int> class K>
    __inline__ __device__ __host__ REAL ConvolutionKernel<REAL, D, K>::get_width() const
    {
        return width_;
    }
    ...
    template<class REAL, unsigned int D, template<class, unsigned int> class K>
    __inline__ __device__ __host__ REAL ConvolutionKernel<REAL, D, K>::get_radius() const
    {
        return radius_;
    }
    ...
    __inline__ __device__ __host__ KaiserKernel<REAL, D>::KaiserKernel(
    ...
    template<class REAL, unsigned int D>
    __inline__ __device__ __host__ REAL KaiserKernel<REAL, D>::compute(const vector_td<REAL, D>& u) const
    {
    ...
    template<class REAL, unsigned int D>
    __inline__ __device__ __host__ REAL KaiserKernel<REAL, D>::compute(REAL r, size_t ax) const
    {
        return KaiserBessel(
            r,
    ...
    template<class REAL, unsigned int D>
    __inline__ __device__ __host__ vector_td<REAL, D> KaiserKernel<REAL, D>::get_beta() const
    {
        return this->beta_;
    }
    ...
    template<class REAL, unsigned int D>
    __inline__ __device__ __host__ vector_td<REAL, D> KaiserKernel<REAL, D>::compute_beta() const
    {
        // Square utility.
    ...
    template<class REAL, unsigned int D>
    __inline__ __device__ __host__ JincKernel<REAL, D>::JincKernel(
        float kernelWidth)
    ...
    template<class REAL, unsigned int D>
    __inline__ __device__ __host__ REAL JincKernel<REAL, D>::compute(const vector_td<REAL, D>& u) const
    {
    ...
    template<class REAL, unsigned int D>
    __inline__ __device__ __host__ REAL JincKernel<REAL, D>::compute(REAL r, size_t ax) const
    {
        // Normalize radius.
        r /= this->radius_;
