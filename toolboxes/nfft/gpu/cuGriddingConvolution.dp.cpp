...
/* DPCT_ORIG #include "ConvolverC2NC.cuh"*/
#include "ConvolverC2NC.dp.hpp"
/* DPCT_ORIG #include "ConvolverNC2C_atomic.cuh"*/
#include "ConvolverNC2C_atomic.dp.hpp"
/* DPCT_ORIG #include "ConvolverNC2C_sparse.cuh"*/
#include "ConvolverNC2C_sparse.dp.hpp"
...
/* DPCT_ORIG         dim3 dimGrid((this->plan_.num_samples_ + dimBlock.x - 1) / dimBlock.x,*/
        ...
        /*
        DPCT1083:67: The size of local memory in the migrated code may be different from the original code. Check that
...
/* DPCT_ORIG             NFFT_convolve_kernel<T, D, K>
            ...
            /*
            DPCT1049:77: The work-group size passed to the SYCL kernel may exceed the limit. To get the device limit,
            query info::device::max_work_group_size. Adjust the work-group size if needed.
            */
        /*
        DPCT1129:76: The type "vector_td<unsigned int, D>" is used in the SYCL kernel, but it is not device
        ...
        */
        {
            ...
            dpct::get_in_order_queue().submit([&](sycl::handler& cgh) {
                ...
                auto raw_pointer_cast_this_plan__trajectory__ct4 = raw_pointer_cast(&this->plan_.trajectory_[0]);
                ...
                cgh.parallel_for<dpct_kernel_name<
                    class NFFT_convolve_kernel_c07932, T, dpct_kernel_scalar<D>,
                    dpct_kernel_scalar<K>>>(sycl::nd_range<3>(dimGrid * dimBlock, dimBlock), [=](sycl::nd_item<3>
                                                                                                     item_ct1) {
                    NFFT_convolve_kernel<T, D, K>(
                        vector_td_unsigned_int_D_this_plan__matrix_size_os__ct0,
                        vector_td_unsigned_int_D_this_plan__matrix_padding__ct1, this_plan__num_samples__ct2, num_coils,
...
/* DPCT_ORIG         transform(trajectory.begin(), trajectory.end(),
        ...
        inclusive_scan(c_p_s.begin(), c_p_s.end(), c_p_s_ps.begin(),
                       /* DPCT_ORIG                        thrust::plus<unsigned int>()); */
...
/* DPCT_ORIG         dim3 dimGrid((prod(this->plan_.matrix_size_os_ + this->plan_.matrix_padding_) +*/
        ...
        size_t bytes_per_thread = domain_size_coils * sizeof(T);
        /*
        DPCT1083:68: The size of local memory in the migrated code may be different from the original code. Check that
        the allocated memory size in the migrated code is correct.
        */
        size_t bytes_per_thread_tail = domain_size_coils_tail * sizeof(T);
...
/* DPCT_ORIG         cudaFuncSetCacheConfig(NFFT_H_convolve_kernel<T, D, K>,
        ...
        /*
        DPCT1026:247: The call to cudaFuncSetCacheConfig was removed because SYCL currently does not support configuring
...
/* DPCT_ORIG             NFFT_H_convolve_kernel<T, D, K>
                ...
                this->plan_.d_kernel_);*/
            /*
            DPCT1049:79: The work-group size passed to the SYCL kernel may exceed the limit. To get the device limit,
            query info::device::max_work_group_size. Adjust the work-group size if needed.
            */
        /*
        DPCT1129:78: The type "vector_td<unsigned int, D>" is used in the SYCL kernel, but it is not device
        copyable. The sycl::is_device_copyable specialization has been added for this type. Please review the code.
        */
        {
            dpct::has_capability_or_fail(dpct::get_in_order_queue().get_device(), {sycl::aspect::fp64});
            ...
            dpct::get_in_order_queue().submit([&](sycl::handler& cgh) {
                ...
                auto raw_pointer_cast_this_plan__trajectory__ct3 = raw_pointer_cast(&this->plan_.trajectory_[0]);
                auto
                ...
                cgh.parallel_for<dpct_kernel_name<
                    class NFFT_H_convolve_kernel_1fee1f, T, dpct_kernel_scalar<D>,
                    dpct_kernel_scalar<K>>>(sycl::nd_range<3>(dimGrid * dimBlock, dimBlock), [=](sycl::nd_item<3>
                                                                                                     item_ct1) {
                    NFFT_H_convolve_kernel<T, D, K>(
                        vector_td_unsigned_int_D_this_plan__matrix_size_os__this_plan__matrix_padding__ct0,
                        this_plan__num_samples__ct1, num_coils, raw_pointer_cast_this_plan__trajectory__ct3,
                        padded_image_get_data_ptr_repetition_prod_this_plan__matrix_size_os__this_plan__matrix_padding__this_plan__num_frames__domain_size_coils_ct4,
...
/* DPCT_ORIG         wrap_image_kernel<T, D>
            ...
            accumulate);*/
        /*
        DPCT1049:81: The work-group size passed to the SYCL kernel may exceed the limit. To get the device limit, query
        info::device::max_work_group_size. Adjust the work-group size if needed.
        */
    /*
    DPCT1129:80: The type "vector_td<unsigned int, D>" is used in the SYCL kernel, but it is not device copyable.
    ...
    */
    {
        ...
        dpct::get_in_order_queue().submit([&](sycl::handler& cgh) {
            ...
            cgh.parallel_for<dpct_kernel_name<class wrap_image_kernel_bdaf9b, T, dpct_kernel_scalar<D>>>(
                sycl::nd_range<3>(dimGrid * dimBlock, dimBlock), [=](sycl::nd_item<3> item_ct1) {
                    wrap_image_kernel<T, D>(source_get_data_ptr_ct0, target_get_data_ptr_ct1,
                                            ...
                                            vector_td_unsigned_int_D_this_plan__matrix_padding__ct3, accumulate);
                });
        });
    }
...
/* DPCT_ORIG         dim3 dimGrid((this->plan_.num_samples_ + dimBlock.x - 1) / dimBlock.x,*/
        ...
        size_t bytes_per_thread_tail =
            /*
            DPCT1083:69: The size of local memory in the migrated code may be different from the original code. Check
...
/* DPCT_ORIG             NFFT_H_atomic_convolve_kernel<T, D, K>
                ...
                this->plan_.d_kernel_);*/
            /*
            DPCT1049:83: The work-group size passed to the SYCL kernel may exceed the limit. To get the device limit,
            query info::device::max_work_group_size. Adjust the work-group size if needed.
            */
        /*
        DPCT1129:82: The type "vector_td<unsigned int, D>" is used in the SYCL kernel, but it is not device
        copyable. The sycl::is_device_copyable specialization has been added for this type. Please review the code.
        */
        {
            dpct::has_capability_or_fail(dpct::get_in_order_queue().get_device(), {sycl::aspect::fp64});
            ...
            dpct::get_in_order_queue().submit([&](sycl::handler& cgh) {
                ...
                auto
                    image_get_data_ptr_repetition_prod_this_plan__matrix_size_os__this_plan__num_frames__domain_size_coils_ct6 =
                        image.get_data_ptr() +
                        repetition * prod(this->plan_.matrix_size_os_) * this->plan_.num_frames_ * domain_size_coils;
                auto this_plan__d_kernel__ct7 = this->plan_.d_kernel_;

                cgh.parallel_for<dpct_kernel_name<
                    class NFFT_H_atomic_convolve_kernel_15d6e6, T, dpct_kernel_scalar<D>,
                    dpct_kernel_scalar<K>>>(sycl::nd_range<3>(dimGrid * dimBlock, dimBlock), [=](sycl::nd_item<3>
                                                                                                     item_ct1) {
