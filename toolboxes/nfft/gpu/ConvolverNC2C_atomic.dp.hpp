...
/* DPCT_ORIG     if (!isfinite(weight))*/
    /*
    DPCT1064:249: Migrated isfinite call is used in a macro/template definition and may not be valid for all
...
template <class T, unsigned int D, template <class, unsigned int> class K>
/*
DPCT1110:70: The total declared local variable size in device function NFFT_H_atomic_convolve_kernel exceeds 128 bytes
