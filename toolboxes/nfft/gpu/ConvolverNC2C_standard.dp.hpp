...
/* DPCT_ORIG     write_pairs_kernel<REAL,D><<< gridDim, blockDim >>>
   ...
   tuples_last );*/
    /*
    DPCT1049:71: The work-group size passed to the SYCL kernel may exceed the limit. To get the device limit,
    ...
    */
    {
        ...
        dpct::get_in_order_queue()
            .parallel_for<dpct_kernel_name<class write_pairs_kernel_d8cd2f, REAL, dpct_kernel_scalar<D>>>(
...
/*
DPCT1110:72: The total declared local variable size in device function NFFT_H_convolve exceeds 128 bytes and may
...
/*
DPCT1110:73: The total declared local variable size in device function wrap_image_kernel exceeds 128 bytes and may
   cause high register pressure. Consult with your hardware vendor to find the total register size available and adjust
   the code, or use smaller sub-group size to avoid high register pressure.
*/
