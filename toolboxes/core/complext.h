...
/* DPCT_ORIG         return exp(com._real) * complext<T>(cos(com._imag), sin(com._imag));*/
        return sycl::exp(com._real) * complext<T>(sycl::cos(com._imag), sycl::sin(com._imag));
    }
...
/* DPCT_ORIG         return atan2(comp._imag, comp._real);*/
        return sycl::atan2(comp._imag, comp._real);
    }
