...
/*
DPCT1044:149: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
...
/* DPCT_ORIG   __device__ typename Gadgetron::realType<T>::Type operator()(const T &x) const {return abs(x);}*/
  typename Gadgetron::realType<T>::Type operator()(const T& x) const { return sycl::fabs((Gadgetron::realType<T>::Type)x); }
};
 ...
 * realType<T>::Type>*/
/*
DPCT1044:150: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:151: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
template <typename T> struct cuNDA_sqrt {
/* DPCT_ORIG   __device__ T operator()(const T &x) const {return sqrt(x);}*/
  /*
  DPCT1064:152: Migrated sqrt call is used in a macro/template definition and may not be valid for all
...
/*
DPCT1044:153: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:154: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:155: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
template <typename T> struct cuNDA_reciprocal_sqrt {
/* DPCT_ORIG   __device__ T operator()(const T &x) const {return T(1)/sqrt(x);}*/
  /*
  DPCT1064:156: Migrated sqrt call is used in a macro/template definition and may not be valid for all
   * macro/template uses. Adjust the code.
  */
...
/*
DPCT1044:157: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:158: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:159: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:160: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:162: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:163: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:164: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
 ...
 * complext<T> >*/
/*
DPCT1044:165: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:166: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
 ...
 * complext<T> >*/
/*
DPCT1044:167: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:168: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
 ...
 * complext<T> >*/
/*
DPCT1044:169: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:170: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/*
DPCT1044:171: thrust::unary_function was removed because std::unary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::unary_function in the class definition.
*/
...
/* DPCT_ORIG     return sgnX*max(absX-gamma*pow(absX,p-1), typename realType<T>::Type(0));*/
    /*
    DPCT1064:172: Migrated pow call is used in a macro/template definition and may not be valid for all
     * macro/template uses. Adjust the code.
    */
    /*
    DPCT1064:173: Migrated max call is used in a macro/template definition and may not be valid for all
     * macro/template uses. Adjust the code.
    */
 ...
 * realType<T>::Type,T>*/
/*
DPCT1044:174: thrust::binary_function was removed because std::binary_function has been deprecated in C++11. You may
 ...
 * realType<T>::Type,T>*/
/*
DPCT1044:175: thrust::binary_function was removed because std::binary_function has been deprecated in C++11. You may
 * need to remove references to typedefs from thrust::binary_function in the class definition.
*/
...
/* DPCT_ORIG     return x/s*max(s-gamma*pow(s,p-1),typename realType<T>::Type(0));*/
    /*
    DPCT1064:176: Migrated pow call is used in a macro/template definition and may not be valid for all
     * macro/template uses. Adjust the code.
    */
    /*
    DPCT1064:177: Migrated max call is used in a macro/template definition and may not be valid for all
     * macro/template uses. Adjust the code.
    */
