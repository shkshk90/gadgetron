...
/* DPCT_ORIG     origin_mirror_kernel<complext<REAL>,D><<< gridDim, blockDim >>>
   ...
   out->get_data_ptr(), true );*/
    /*
    DPCT1049:88: The work-group size passed to the SYCL kernel may exceed the limit. To get the device limit, query
    info::device::max_work_group_size. Adjust the work-group size if needed.
    */
    /*
    DPCT1129:87: The type "vector_td<unsigned int, D>" is used in the SYCL kernel, but it is not device copyable. The
