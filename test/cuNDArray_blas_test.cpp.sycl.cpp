...
TYPED_TEST(cuNDArray_blas_Real,aminTest){
  ...
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue()
          .memcpy(&this->Array.get_data_ptr()[4], &tmp, sizeof(TypeParam))
          .wait()));
  ...
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue()
          .memcpy(&this->Array.get_data_ptr()[48], &tmp, sizeof(TypeParam))
          .wait()));
...
TYPED_TEST(cuNDArray_blas_Cplx,aminTest){
  ...
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue()
          .memcpy(&this->Array.get_data_ptr()[23], &tmp, sizeof(TypeParam))
          .wait()));
  ...
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue()
          .memcpy(&this->Array.get_data_ptr()[1000], &tmp, sizeof(TypeParam))
          .wait()));
...
TYPED_TEST(cuNDArray_blas_Cplx,amaxTest){
  ...
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue()
          .memcpy(&this->Array.get_data_ptr()[3], &tmp, sizeof(TypeParam))
          .wait()));
  ...
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue()
          .memcpy(&this->Array.get_data_ptr()[999], &tmp, sizeof(TypeParam))
          .wait()));
