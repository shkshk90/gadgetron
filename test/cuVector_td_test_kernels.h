...
/* DPCT_ORIG template<class T, unsigned int D> thrust::device_vector<T> test_norm(cuNDArray< vector_td<T,D> >* data);*/
template <class T, unsigned int D> dpct::device_vector<T> test_norm(cuNDArray<vector_td<T, D>>* data);
/* DPCT_ORIG template<class T, unsigned int D> thrust::device_vector<T> test_min(cuNDArray< vector_td<T,D> >* data);*/
template <class T, unsigned int D> dpct::device_vector<T> test_min(cuNDArray<vector_td<T, D>>* data);

/* DPCT_ORIG template<class T, unsigned int D> thrust::device_vector<T> test_max(cuNDArray< vector_td<T,D> >* data);*/
