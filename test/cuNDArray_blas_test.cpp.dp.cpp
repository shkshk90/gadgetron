...
TYPED_TEST(cuNDArray_blas_Real,aminTest){
  ...
  TypeParam tmp(-50);
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[4], &tmp, sizeof(TypeParam), cudaMemcpyHostToDevice));*/
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[4], &tmp, sizeof(TypeParam)).wait()));
  EXPECT_EQ(4, amin(&this->Array));
  EXPECT_EQ(4, amin(&this->Array,16));
  EXPECT_EQ(4, amin(&this->Array,17));

  tmp = TypeParam(2);
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[48], &tmp, sizeof(TypeParam),
 * cudaMemcpyHostToDevice));*/
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[48], &tmp, sizeof(TypeParam)).wait()));
 ...
 * cudaMemcpyHostToDevice));*/
  ...
  EXPECT_EQ(23, amin(&this->Array,17));
  tmp = TypeParam(-2, -76);
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[1000], &tmp, sizeof(TypeParam),
 * cudaMemcpyHostToDevice));*/
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[1000], &tmp, sizeof(TypeParam)).wait()));
...
TYPED_TEST(cuNDArray_blas_Cplx,amaxTest){
  fill(&this->Array, TypeParam(1, 1));
  TypeParam tmp(4, 4);
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[3], &tmp, sizeof(TypeParam), cudaMemcpyHostToDevice));*/
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[3], &tmp, sizeof(TypeParam)).wait()));
 ...
 * cudaMemcpyHostToDevice));*/
  ...
  tmp = TypeParam(-3, -6);
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[999], &tmp, sizeof(TypeParam),
 * cudaMemcpyHostToDevice));*/
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[999], &tmp, sizeof(TypeParam)).wait()));
