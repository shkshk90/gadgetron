...
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[19100], &tmp2, sizeof(TypeParam),
 * cudaMemcpyHostToDevice));*/
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[19100], &tmp2, sizeof(TypeParam)).wait()));
  ...
  fill(&this->Array,TypeParam(-5.7));
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[9100], &tmp, sizeof(TypeParam),
 * cudaMemcpyHostToDevice));*/
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[9100], &tmp, sizeof(TypeParam)).wait()));
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[19100], &tmp2, sizeof(TypeParam),
 * cudaMemcpyHostToDevice));*/
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[19100], &tmp2, sizeof(TypeParam)).wait()));
...
TYPED_TEST(cuNDArray_elemwise_TestReal,clampTest){
  fill(&this->Array,TypeParam(-5.7));
  TypeParam tmp(101.3);
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[354222], &tmp, sizeof(TypeParam),
 * cudaMemcpyHostToDevice));*/
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[354222], &tmp, sizeof(TypeParam)).wait()));
...
TYPED_TEST(cuNDArray_elemwise_TestCplx,clamp_minTest){
  fill(&this->Array,TypeParam(-5.7, -4.6));
  TypeParam tmp(-101.3,-203.4);
/* DPCT_ORIG   CUDA_CALL(cudaMemcpy(&this->Array.get_data_ptr()[91], &tmp, sizeof(TypeParam), cudaMemcpyHostToDevice));
 */
  CUDA_CALL(DPCT_CHECK_ERROR(
      dpct::get_in_order_queue().memcpy(&this->Array.get_data_ptr()[91], &tmp, sizeof(TypeParam)).wait()));
