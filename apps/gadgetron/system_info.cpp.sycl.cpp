...
namespace Gadgetron::Server::Info {
    ...
    namespace CUDA {
        ...
        int cuda_device_count() try {
            ...
            */
            /*
            DPCT1000:83: Error handling if-stmt was detected but could not be
            rewritten.
            */
            if (error) return 0;
            return deviceCount;
        ...
        std::string cuda_driver_version() {
            int version = 0;
            /*
            DPCT1043:84: The version-related API is different in SYCL. An
        ...
        std::string cuda_runtime_version() {
            int version = 0;
            /*
            DPCT1043:85: The version-related API is different in SYCL. An
            initial code was generated, but you need to adjust it.
            */
            version = dpct::get_major_version(dpct::get_current_device());
            return format_version(version);
        ...
        std::string cuda_device_capabilities(int device) {
            ...
            */
            stream << properties.get_major_version() << "."
                   << properties.get_minor_version();
